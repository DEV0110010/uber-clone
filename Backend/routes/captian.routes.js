...
router.get("/profile", authMiddleare.authCaptain ,captainController.getCaptainProfile);

router.get("/logout", authMiddleare.authCaptain, captainController.logoutCaptain)
